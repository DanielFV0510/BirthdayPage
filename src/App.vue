          ...
          <div class="final-message">
            <div class="message-box">
              ...
              <div class="wishes-container">
                ...
                <div class="wish-item">💫👑 Sueños por realizar y alcanzar</div>
                <div class="wish-item">💖💕 Muchas aventuras juntos</div>
                <div class="wish-item">🌸💎 Momentos tiernos y cariñosos</div>
              </div>
              <div class="signature">
                <div class="signature-text">Con todo mi amor 💖💕💎</div>
                <div class="signature-heart">💝</div>
                <div class="romantic-signature">
                  De tu chico que te quiere muchísimo 👑💕
                </div>
              </div>
            </div>
          </div>
...
.big-kitty-svg {
  ...
  transition: all 0.3s ease;
  animation: kittyGlow 3s infinite ease-in-out;
}
